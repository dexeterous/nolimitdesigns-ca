        ...
        <div className="container">
          <div className="md:w-[80%] mx-auto text-center">
            <h3 className="border border-[#bebebe] py-2.5 px-5 rounded-3xl md:text-base md:leading-5 text-sm inline-block font-normal mb-[5px]">
              <i className="ri-megaphone-line"></i> Marketing Design Services
            </h3>
            ...
            <p className="text-xl leading-7 mb-[5px] text-black-100">
              Power your marketing campaigns with unlimited design for ads, landing pages, email campaigns, and more.
            </p>
        ...
        <div className="container">
          <div className="text-center pb-15">
            ...
            <p className="md:text-xl md:leading-7 text-base mt-2">
              Everything you need to power your marketing campaigns
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Display ads, social media ads, Google Ads, retargeting banners, and video ads",
              },
              {
                icon: "ri-pages-line",
                title: "Landing Pages",
              ...
              },
              {
                ...
                description: "Email templates, newsletters, promotional emails, and drip campaign designs",
              },
              {
                icon: "ri-slideshow-line",
                title: "Presentations",
                description: "Sales decks, pitch presentations, webinar slides, and investor presentations",
              },
              {
                icon: "ri-file-chart-line",
                title: "Lead Magnets",
                description: "Ebooks, guides, checklists, templates, and downloadable resources",
              },
              {
                icon: "ri-bar-chart-box-line",
                title: "Case Studies",
                description: "Customer success stories, testimonial designs, and results showcases",
              },
            ].map((item, index) => (
              <div
                key={index}
      ...
      <section className="lg:pt-25 pt-15">
        <div className="container">
          <div className="text-center pb-15">
            ...
            <p className="md:text-xl md:leading-7 text-base mt-2">Marketing design that drives results</p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Get your marketing materials in 1-2 business days so you can launch campaigns quickly and stay ahead of the competition.",
                icon: "ri-timer-flash-line",
              },
              {
                title: "Conversion-Focused",
                description:
                  "We design with conversion in mind, using proven design principles and best practices to maximize your campaign performance.",
                icon: "ri-line-chart-line",
              },
              {
                title: "Brand Consistency",
                description:
                  "All designs follow your brand guidelines to ensure consistent messaging across all marketing channels and touchpoints.",
                icon: "ri-palette-line",
              },
              {
                title: "A/B Test Ready",
                description:
                  "Need multiple variations? We'll create different versions of your designs so you can test and optimize for better results.",
              ...
              <div key={index} className="flex gap-5 p-7.5 border border-[#bebebe] rounded-[15px]">
                ...
                <div>
                  <h3 className="lg:text-3xl text-[26px] font-medium mb-3">{benefit.title}</h3>
                  <p className="lg:text-lg text-base">{benefit.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="lg:pt-25 pt-15">
        <div className="container">
          <div className="lg:w-[75%] mx-auto text-center lg:px-12.5 py-7.5 px-8 border border-[rgba(0,0,0,0.05)] rounded-[20px]">
            ...
            <p className="md:text-xl md:leading-7 text-base mt-2">
              Get unlimited marketing design to fuel your campaigns and drive growth.
            </p>
            <div className="mt-7.5">
              <Link
                href="/#pricing"

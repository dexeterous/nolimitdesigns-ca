        ...
        <div className="container">
          <div className="md:w-[80%] mx-auto text-center">
            ...
            <p className="text-xl leading-7 mb-[5px] text-black-100 max-w-2xl mx-auto">
              Create comprehensive brand guidelines that ensure consistency across all your marketing materials. From
              logo usage to color palettes, we document your brand identity perfectly.
            </p>
        ...
        <div className="container">
          <div className="text-center pb-15">
            ...
            <p className="md:text-xl md:leading-7 text-base mt-2">
              Complete brand documentation for consistent brand identity
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Clear specifications for logo usage, variations, spacing, sizing, and what not to do",
              },
              {
                icon: "ri-contrast-2-line",
                title: "Color Palette",
                description: "Primary, secondary, and accent colors with HEX, RGB, and CMYK values",
              },
              {
                icon: "ri-text",
                title: "Typography",
                description: "Font families, weights, sizes, and hierarchy for headings and body text",
              },
              {
                icon: "ri-image-2-line",
                title: "Imagery Style",
                description: "Photography and illustration guidelines that define your visual style",
              },
              {
                icon: "ri-shapes-line",
                title: "Iconography",
                description: "Icon style, usage guidelines, and a library of brand-specific icons",
              },
              {
      ...
      <section className="py-15">
        <div className="container">
          <h2 className="text-center xl:text-[60px] md:text-[45px] text-[35px] font-medium mb-15">
            Everything included in your brand guide
          </h2>
            ...
            {[
              {
                title: "Logo Guidelines",
                description:
                  "Clear specifications for logo usage, variations, spacing, sizing, and what not to do with your logo.",
                image: "/logo-guidelines-design.jpg",
              },
              {
                title: "Color Palette",
                description:
                  "Primary, secondary, and accent colors with HEX, RGB, and CMYK values for all applications.",
                image: "/color-palette-guide.jpg",
              },
              {
                title: "Typography",
                description:
                  "Font families, weights, sizes, and hierarchy for headings, body text, and special elements.",
                image: "/typography-guide-design.jpg",
              },
              {
                title: "Imagery Style",
                description:
                  "Photography and illustration guidelines that define your visual style and brand aesthetic.",
                image: "/imagery-style-guide.jpg",
              },
              {
                title: "Iconography",
                description: "Icon style, usage guidelines, and a library of brand-specific icons for consistency.",
                image: "/iconography-guide-design.jpg",
              },
              {
                title: "Patterns & Graphics",
                description: "Brand patterns, textures, and graphic elements for various applications and touchpoints.",
                image: "/patterns-graphics-guide.jpg",
              },
              {
                title: "Voice & Tone",
                description: "Brand personality, messaging guidelines, and communication style for all content.",
                image: "/voice-tone-guide.jpg",
              },
              {
                title: "Application Examples",
                description: "Real-world examples showing how to apply the brand across different media and platforms.",
                image: "/brand-application-examples.jpg",
              },
              {
                title: "Do's and Don'ts",
                description: "Clear examples of correct and incorrect brand usage to avoid common mistakes.",
                image: "/brand-dos-donts.jpg",
              },
            ].map((item, index) => (
              <div
                key={index}
            ...
            <div className="bg-white rounded-[20px] p-10 shadow-lg">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-primary">Michael Chen - CEO</p>
                </div>
              </div>
              <p className="text-lg leading-relaxed text-black-100">
                "The brand guide they created for us is incredibly comprehensive and easy to follow. Our entire team now
                has a clear understanding of how to use our brand consistently. It's been a game-changer for our
                marketing efforts and has saved us countless hours of back-and-forth."
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center mb-10">
              <div className="grid grid-cols-2 gap-4">
                {[1, 2, 3, 4].map((i) => (
                  <Image
                    key={i}
                    src={`/brand-guide-.jpg?key=bg${i}&height=250&width=200&query=brand guide ${i}`}
                    alt={`Brand guide ${i}`}
                    width={200}
                    height={250}
              ...
              <div className="text-left">
                <h2 className="text-4xl font-medium mb-4">Brand guides are included in all our plans</h2>
                <p className="text-lg text-black-100 mb-6">
                  All plans include unlimited brand guide requests, unlimited revisions, and cancel anytime.
                </p>
                <Link
                  href="/#pricing"
      ...
      <section className="py-15 bg-[#fff6ec]">
        <div className="container">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              {
                question: "What is included in a brand guide?",
                answer:
                  "A comprehensive brand guide includes logo guidelines, color palette, typography, imagery style, iconography, patterns, voice & tone, application examples, and do's and don'ts.",
              },
              {
                question: "How long does it take to create a brand guide?",
                answer:
                  "Most brand guides are completed within 5-7 business days, depending on the complexity and number of brand elements to document.",
              },
              {
                question: "What format will I receive the brand guide in?",
                answer:
                  "We deliver brand guides in PDF format for easy sharing, and can also provide editable files in Figma or Adobe InDesign upon request.",
              },
              {
                question: "Can you create a brand guide for an existing brand?",
                answer:
                  "Yes! We can document your existing brand identity and create comprehensive guidelines to ensure consistency going forward.",
              },
              {
                question: "Do you offer brand guide updates?",
                answer:
                  "As your brand evolves, we can update your brand guide to reflect new elements, colors, or guidelines.",
              },
            ].map((faq, index) => (

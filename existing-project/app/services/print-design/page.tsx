        ...
        <div className="container">
          <div className="md:w-[80%] mx-auto text-center">
            ...
            <p className="text-xl leading-7 mb-[5px] text-black-100 max-w-2xl mx-auto">
              Transform your print materials with stunning designs. From business cards to brochures, get print-perfect
              graphics ready for the press in a few clicks!
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              <div key={i} className="rounded-[15px] overflow-hidden border border-[#bebebe]">
                <Image
                  src={`/placeholder.svg?height=400&width=600&query=print design example ${i}`}
                  alt={`Print design ${i}`}
                  width={600}
                  height={400}
      ...
      <section className="py-15">
        <div className="container">
          <h2 className="text-center xl:text-[60px] md:text-[45px] text-[35px] font-medium mb-15">
            One place for all your print designs
          </h2>
            ...
            {[
              {
                ...
                description:
                  "Make a lasting first impression with professionally designed business cards that reflect your brand identity.",
                image: "/placeholder.svg?height=300&width=400",
              },
              {
                title: "Flyers",
                description:
                  "Eye-catching flyers that grab attention and effectively communicate your message to your target audience.",
                image: "/placeholder.svg?height=300&width=400",
              },
              {
                title: "Stationery Design",
                description:
                  "Complete stationery sets including letterheads, envelopes, and notepads that elevate your brand.",
                image: "/placeholder.svg?height=300&width=400",
              },
              {
                title: "Posters",
                description: "Bold, attention-grabbing posters for events, promotions, or decorative purposes.",
                image: "/placeholder.svg?height=300&width=400",
              },
              {
                title: "Billboards",
                description: "Large-format billboard designs that make an impact and reach thousands of viewers.",
                image: "/placeholder.svg?height=300&width=400",
              },
              {
                title: "Menus",
                description:
                  "Beautifully designed restaurant menus that enhance the dining experience and showcase your offerings.",
                image: "/placeholder.svg?height=300&width=400",
              },
              {
                title: "Brochures",
                description:
                  "Multi-page brochures that tell your story and present information in an organized, visually appealing way.",
                image: "/placeholder.svg?height=300&width=400",
              },
              {
                title: "Booklets",
                description:
                  "Professional booklets for catalogs, guides, or informational materials with perfect binding-ready layouts.",
                image: "/placeholder.svg?height=300&width=400",
              },
              {
                title: "Business Reports",
                description:
                  "Polished business reports and white papers that present data and insights professionally.",
                image: "/placeholder.svg?height=300&width=400",
              },
            ].map((item, index) => (
              <div
            ...
            <div className="bg-white rounded-[20px] p-10 shadow-lg">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-primary">Jose - Small Business Owner</p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center mb-10">
              <div className="grid grid-cols-2 gap-4">
                {[1, 2, 3, 4].map((i) => (
                  <Image
                    key={i}
                    src={`/placeholder.svg?height=200&width=200&query=print design ${i}`}
                    alt={`Design ${i}`}
                    width={200}
                    height={200}
              ...
              <div className="text-left">
                <h2 className="text-4xl font-medium mb-4">Print design is included in all our plans</h2>
      ...
      <section className="py-15 bg-secondary">
        <div className="container">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              {
                question: "Can you do any type of print design?",
                answer:
                  "Yes! From business cards to billboards, we handle all types of print design projects. Just let us know your specifications and we'll deliver print-ready files.",
              },
              {
                question: "How often will you provide updates on my graphic design?",
                answer:
                  "We provide regular updates throughout the design process and typically deliver initial concepts within 24-48 hours.",
              },
              {
                question: "What's the turnaround time?",
                answer:
                  "Most print design requests are completed within 1-2 business days. Complex multi-page projects may take longer.",
              },
              {
                question: "Can I modify the design?",
                answer:
                  "All plans include unlimited revisions until you're completely satisfied with the final design.",
              },
              {
                question: "Do you provide print-ready files?",
                answer:
                  "Yes! We deliver high-resolution, print-ready files in the format required by your printer (PDF, AI, EPS, etc.) with proper bleed and crop marks.",
              },
            ].map((faq, index) => (
